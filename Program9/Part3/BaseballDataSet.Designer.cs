...
namespace Part3.BaseballDataSetTableAdapters {
...
SELECT PlayerID, FirstName, LastName, BattingAverage FROM Players WHERE (PlayerID = @PlayerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Part3.Properties.Settings.Default.BaseballConnectionString;
        }
        ...
        public virtual int FillByLastName(BaseballDataSet.PlayersDataTable dataTable, string LastName) {
        ...
        public virtual BaseballDataSet.PlayersDataTable GetDataBy(string LastName) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((LastName == null)) {
                throw new global::System.ArgumentNullException("LastName");
            }
